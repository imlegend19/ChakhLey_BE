...
class ValidateAndPerformView(APIView):
    """
    An abstract class that provides a APIView in various projects for
    easily doing certain tasks.
    ...
    def validated(self, serialized_data, *args, **kwargs):
        """
        This method should return data and HTTP Status Code of the
        operation that is needed to be performed.
        Parameters
        ----------
        serialized_data: serializer_class
            This is the serialized data that has been validated.
        args: tuple
            This contains extra positional arguments that can be sent
            upon call.
        kwargs: dict
            This contains key-value paired arguments that can be sent
            upon call.

        Returns
        -------
        data: dict
            This contains relevant information that will be returned
            after the operation has been performed
        status_code: int
            This will reflect the status code of the operation that has
            been performed.
